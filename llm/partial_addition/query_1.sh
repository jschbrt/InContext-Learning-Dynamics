...
#SBATCH --job-name=partial_addition_1
...
python query.py --success 0.5 --fail -0.5 --num_options 2
python query.py --success 1.0 --fail 0.0 --num_options 2

python query.py --success 1.0 --fail 0.0 --num_options 3
